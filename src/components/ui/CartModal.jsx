    ...
    return (
        ...
        `}>
            <div className="flex items-center justify-between">
                <h1 className="text-white text-[2rem] font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
            ...
            <div className="flex gap-3">
                <button 
                    className="flex-1 bg-gradient-to-r from-purple-600 to-pink-600 p-4 rounded-xl shadow-lg hover:from-purple-700 hover:to-pink-700 transition-all duration-300 font-bold text-white text-lg hover:scale-[1.02] active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                    disabled={!totalItems}
                >
                    {totalItems ? '🎉 Proceed to Checkout' : 'Add items to order'}
                </button>
                <button 
                    className="px-6 bg-gradient-to-r from-red-600 to-pink-600 p-4 rounded-xl shadow-lg hover:from-red-700 hover:to-pink-700 transition-all duration-300 font-bold text-white hover:scale-[1.02] active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                    disabled={!totalItems}
                    onClick={() => {
